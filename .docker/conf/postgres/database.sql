...
CREATE TABLE email_logger (
  email_logger_id serial PRIMARY KEY,
  email_logger_mail_to varchar(255) NOT NULL,
  email_logger_mail_subject varchar(255) NOT NULL,
  email_logger_mail_body text NOT NULL,
  email_logger_created_at timestamp NOT NULL,
  email_logger_sent_at timestamp DEFAULT NULL
);
